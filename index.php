...
<body>
	...
	<h1>LIBRARY MANAGEMENT SYSTEM For admin side</h1>
	<h3>Use Database Name "LMS"</h3>
	...
	<div class="container">
		...
		<div class="register">
			<h2>Sign Up</h2>
			<h3>Students can be signed up only via operator.</h3>
			<form action="index.php" method="post">
	...
	<div class="footer w3layouts agileits">
		<p> &copy; All Rights Reserved by Sazid Hassan Khan, C181047 </a></p>
